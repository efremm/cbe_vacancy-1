...
<div class="row">
    ...
    <ul class="list-group" >
        <li  class="list-group-item " style="border: none"><h3> <a href="<?php echo base_url('admin/home')?>">
                    <span class="fa fa-home"></span> Quick Links</a>  </h3></li>
        ...
        <li class="list-group-item" style="border: none"> <a href="<?php echo base_url()?>Admin/sendMail" id="sendMail">
                <span class="fa fa-1x fa-edit"></span> send Email to  candidates</a> </li>
        <li class="list-group-item" style="border: none"> <a href="<?php echo base_url()?>Admin/sendsms" id="addresearch">
                <span class="fa fa-1x fa-edit"></span> send SMS to  candidates</a> </li>
